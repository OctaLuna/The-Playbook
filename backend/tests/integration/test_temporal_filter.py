...
def test_temporal_filter_sql_condition_logic():
    ...
    """
    kickoff = datetime(2026, 8, 28, 19, 0, 0, tzinfo=timezone.utc)
    
    pre_kickoff_news = datetime(2026, 8, 27, 10, 0, 0, tzinfo=timezone.utc)
    post_kickoff_news = datetime(2026, 8, 28, 21, 30, 0, tzinfo=timezone.utc)
    same_moment_news = datetime(2026, 8, 28, 19, 0, 0, tzinfo=timezone.utc)
    ...
    assert not (same_moment_news < kickoff), "La noticia coincidente con el kickoff DEBE ser excluida"
