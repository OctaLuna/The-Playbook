...
class Evidencia(Base):
    ...
    fecha_publicacion: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, index=True)
    ...
    equipo_relacionado_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
    partido_relacionado_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
